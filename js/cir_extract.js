console.log("cir_extract.js loaded");
...
// ===============================
function runProcess() {
    if (!rawData.length && !resultData.length) {
...
function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "CIR Result");
    XLSX.writeFile(wb, "hasil_cir_extract.xlsx");
}
